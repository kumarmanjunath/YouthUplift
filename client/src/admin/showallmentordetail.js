  ...
  onDeleteUser = async (_id, e) => {
    ...
    try {
      const res = await axios.delete(
        `http://localhost:5000/api/v1/mentors/${_id}`,
        config
      );
                    ...
                    <div className='well'>
                      ...
                      <table className='table table-hover'>
                        ...
                        {this.state.mentors.map((doc) => (
                          <tr>
                            <td className='tbld text-dark'>{doc.fname}</td>
                            {/* <td className='tbld text-dark'>
                              {doc.profession.catname}
                            </td> */}
                            <td className='tbld text-dark'>{doc.experience}</td>
                            <td className='tbld text-dark'>{doc.address}</td>
                            <td className='tbld text-dark'>{doc.email}</td>
                            <td className='tbld text-dark'>{doc.phone}</td>

                            {/* {this.state.profession.map((doc1) => (
                              <tr>
                                <td className='tbld text-dark'>
                                  {doc1.professions}
                                </td>
